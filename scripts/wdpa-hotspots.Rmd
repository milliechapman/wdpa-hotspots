...
```{r fig1, fig.height=6, fig.width=8, dpi= 300}
...
```{r fig2, fig.height=6, fig.width=8, dpi=300}
c_yr <- metrics_yr %>%
...
```{r fig3a, fig.height=7, fig.width=8, dpi=300}
ggarrange(pa_bio,ce_bio,pa_hab,ce_hab, ncol = 2, nrow = 2, common.legend = FALSE)
```

```{r fig3b, fig.height=3.5, fig.width=8, dpi=300}
...
```{r fig4, fig.width=6, fig.height=5, dpi = 300}
